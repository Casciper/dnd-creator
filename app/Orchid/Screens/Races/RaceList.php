...
class RaceList extends ListScreenPattern
{
            ...
            Layout::table('items', [
                ...
                TD::make()->width(10)->alignRight()->cantHide()
                    ...
                    DropDown::make()->icon('options-vertical')->list([
                        Link::make('Редактировать')->icon('wrench')->route(OrchidRoutes::RACES->edit(), $item),
    ...
    public function deleteItem(Race $item)
    {
        $id = $item->id;
        $title = $item->getTitle();
