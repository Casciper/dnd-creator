...
class OriginEdit extends EditScreenPattern
{
    protected string $createTitle = 'Создание происхождения';
    protected string $updateTitle = 'Редактирование происхождения';
    protected string $deleteMessage = 'Происхождение успешно удален';
    protected string $createMessage = 'Происхождение успешно добавлен';
    ...
    public function query(Origin $item)
    {
        return $this->queryMake($item);
    }

    public function save(Origin $item, Request $request)
    {
    ...
    public function remove(Origin $item)
    {
